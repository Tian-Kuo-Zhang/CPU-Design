module CPU_Top (
    ...
    // ============================================================
    (* mark_debug = "true" *) wire [7:0]  rom_addr;
    reg  [15:0] rom_data;
    ...
    (* mark_debug = "true" *) wire [15:0] instr;
    wire [15:0] rdata1;
    wire [15:0] rdata2;
    wire [15:0] imm_ext;
    wire [15:0] alu_b;
    ...
    wire [15:0] rf_wdata;
    wire [1:0]  rf_waddr;
    (* mark_debug = "true" *) wire        rf_regwrite;
    ...
    // Keep a small, low-risk ILA footprint focused on interlock timing.
    (* mark_debug = "true" *) wire [15:0] dbg_ram_addr      = ram_addr;
    (* mark_debug = "true" *) wire        dbg_MemRead       = MemRead;
    (* mark_debug = "true" *) wire        dbg_mem_read      = mem_read;
    (* mark_debug = "true" *) wire        dbg_mem_wait      = mem_wait;
    (* mark_debug = "true" *) wire [1:0]  dbg_rf_waddr      = rf_waddr;
    (* mark_debug = "true" *) wire [15:0] dbg_rf_wdata      = rf_wdata;
    (* mark_debug = "true" *) wire [1:0]  dbg_load_waddr    = load_waddr;
    (* mark_debug = "true" *) wire [15:0] dbg_ram_rdata_mem = ram_rdata_mem;
